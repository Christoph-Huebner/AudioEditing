...
def main():
    ...
    parser_opt_org_com_dc.add_argument("-th", "--threshold", default="-18", dest="threshold", help="Threshold (default: -18 dB)")
    parser_opt_org_com_dc.add_argument("-rt", "--ratio", type=float, default=2.0, dest="ratio", help="Compression ratio (default: 2.0)")
    parser_opt_org_com_dc.add_argument("-at", "--attack", type=int, default=20, dest="attack", help="Attack time in milliseconds (default: 20 ms)")
    parser_opt_org_com_dc.add_argument("-re", "--release", type=int, default=250, dest="release", help="Release time in milliseconds (default: 250 ms)")
